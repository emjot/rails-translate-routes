...
Gem::Specification.new do |s|
  ...
  s.date = "2012-08-03"
  s.description = "Simple gem to translate routes in Rails 3.x and Rails 4.x based on translate_routes"
  ...
  s.summary = "Simple gem to translate routes in Rails 3.x and Rails 4.x"
